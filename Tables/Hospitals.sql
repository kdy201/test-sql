...
FOREIGN KEY (doctor_id) REFERENCES Doctors(doctor_id),
FOREIGN KEY (hospital_id) REFERENCES Hospitals(hospitals_id)
);
...
LOAD DATA INFILE '/path/to/Hospitals.csv'
...
LOAD DATA INFILE '/path/to/Lab_Results.csv'
...
LOAD DATA INFILE '/path/to/Medications.csv'
...
LOAD DATA INFILE '/path/to/Prescriptions.csv'
...
LOAD DATA INFILE '/path/to/Specialist.csv'
...
LOAD DATA INFILE '/path/to/Diseases.csv'
INTO TABLE Diseases
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
...
LOAD DATA INFILE '/path/to/Disease_Medication.csv'
